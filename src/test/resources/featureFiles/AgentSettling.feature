Feature: Agent Settling Transaction Process Feature
    ...
    #1
  @Smoke @OWTBFContinue @FailureScreenShot
  ...
  #  And Conformation pop up arises - What week do you want to settle? Previous Week
    And Conformation pop up arises - What week do you want to settle? Current Week
 ...
 #2
  @Smoke @OWTBFReset @FailureScreenShot
  ...
  #  And Click Finalize on Orders Waiting To Be Finalized Page and Close
   ...
   #3
  @Smoke  @SettleYourAgent&ViewEpicorExcelReportsContinue @FailureScreenShot
  ...
  #  And Validate Amount in View Epicor Header <VRow2> <VColumn2> with Total Settlement on Final Agent Settlement Summary Table
    ...
    #4
  @Smoke  @SettleYourAgent&ViewEpicorExcelReportsReset @FailureScreenShot
  ...
  #  And Validate Amount in View Epicor Header <VRow2> <VColumn2> with Total Settlement on Final Agent Settlement Summary Table
   ...
   #5
  @Smoke  @SettlementOrderDetailsContinue @FailureScreenShot
 ...
 #  usp_GetSettleOrderReviewDetails
    ...
    #6
  @Smoke @SettlementOrderDetailsReset @FailureScreenShot
  Scenario Outline: Validate Settlement Order Details (reset) on Agent Settling Page in Launch Environment
    ...
    #7
  @Regression @AgentsYoureSettlingAddedRemoved @FailureScreenShot
  ...
  #8
  @Smoke  @AdjustmentsDetailsAndAdjustmentsOnHold @FailureScreenShot
  ...
  #9
  @Regression  @MyActiveAgentsNotSettled @FailureScreenShot
  Scenario Outline: Validate My Active Agents Not Settled on Agent Settling Page in Launch Environment
    ...
    Examples:
      ...
      | "9050"     | "SMRITIDHUNGANA" | "07/12/2022" | "27"      | "ebhlaunch" | "chrome" | "SMRITIDHUNGANA" | "Legendary@1" | "[EBHLaunch].[dbo].[usp_GetSettlementSummaryDetail]" |


    #10
  @Regression @AgentSettlementFlagMaintenance @FailureScreenShot
  Scenario Outline: Validate Agent Settlement Flag Maintenance in Launch Environment
    ...
    #11
  @Regression @DBAgentSettlements&AgentStlTrans @FailureScreenShot
  Scenario Outline: Validate [EBHLaunch].[dbo].[AGENT_SETTLEMENTS] and [EBHLaunch].[dbo].[AGENT_STL_TRANS] on Database
    ...
    Examples:
     ...
     #12
  @Regression @DBOrderDocs&TfDocDataD4 @FailureScreenShot
  Scenario Outline: Validate [EBHLaunch].[dbo].[ORDER_DOCS] and [TRANSFLO].[dbo].[tf_doc_data_d4] on Database
