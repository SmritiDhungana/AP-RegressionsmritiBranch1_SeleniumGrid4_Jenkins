Feature: Agents Currently Being Settled Process Feature


   #16
  @Regression @AgentsCurrentlyBeingSettledVendorCode @FailureScreenShot
  Scenario Outline: Validate Vendors Currently Being Settled in Launch Environment
    ...
    #17
  @Regression @AgentsCurrentlyBeingSettledAgentCode @FailureScreenShot
